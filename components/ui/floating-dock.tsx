    ...
    return (
        <Link href={href}>
            <motion.div
                ...
                className="aspect-square rounded-full bg-gray-200 dark:bg-neutral-800 flex items-center justify-center relative border border-gray-100 dark:border-neutral-700"
            >
                <AnimatePresence>
                    {hovered && (
                        <motion.div
